    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.send_notice:
                Intent intent = new Intent(this, NotifficationActivity.class);
                ...
                Notification notification = new NotificationCompat.Builder(this)
                        ...
                        //.setContentText("Learn how to build notifications, send and sync data," +
                          //      "and use voice actions. Get the offical Android IDE and developer" +
                            //    "tools to build apps ffor Android.")
                        //.setStyle(new NotificationCompat.BigTextStyle().bigText("Learn how to build" +
                        //        "notifications, send and sync data, and use voice actions.Get the offical" +
